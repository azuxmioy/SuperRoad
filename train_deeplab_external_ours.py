...
flags.DEFINE_string('data_path', 'external/', 'directory of dataset')
...
flags.DEFINE_string('encoder_model', None, 'directory of encoder model')
flags.DEFINE_string('decoder_model', None, 'directory of decoder model')
