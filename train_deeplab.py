...
flags.DEFINE_string('encoder_model', 'pretrained/encoder.ckpt-16000', 'directory of encoder model')
flags.DEFINE_string('decoder_model', 'pretrained/decoder.ckpt-16000', 'directory of decoder model')

# Saving directory
flags.DEFINE_string('save_path', '/mydata/runs', 'saving directotry')
