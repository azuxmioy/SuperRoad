...
if __name__ == '__main__':
    ...
    #for i in range (1):
        ...
        #plt.subplot(1,2,1)
        #plt.imshow(np.argmax(soft_mask, axis=2))
        #plt.subplot(1,2,2)
        #plt.imshow(smooth_mask)
        #plt.show()
        
        
    submit(test_output, ids, 'submit.csv')
