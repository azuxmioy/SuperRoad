...
class Dataset:
    def __init__(self, train_input_dirname, train_output_dirname, test_input_dirname):
        ...
        self.cache_dirname = os.path.join(self.dataset_root, "cache.pkl")

        # Check if cached dataset exists
        if os.path.exists(self.cache_dirname):
    ...
    def load_filename_dataset_from_cache(self):
        ...
        try:
            with open(self.cache_dirname, 'rb') as f:
                data = pickle.load(f)
    ...
    def create_dataset_cache(self):
        ...
        with open(self.cache_dirname, 'wb') as f:
            pickle.dump(data, f)
